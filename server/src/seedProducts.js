...
const products = [
  {
    ...
    source_store:'Flipkart',
    source_url:'https://www.flipkart.com/cosmic-byte-raptor-wireless-right-handed-optical-gaming-mouse/p/itm1683cbe52bca5',
    stock:10,is_featured:true,is_new:true,rating:4.5,review_count:62,
    tags:['gaming mouse','wireless','cosmic byte']
  },
  {
    ...
    stock:10,is_featured:true,rating:4.5,review_count:1713,
    tags:['gaming mouse','wireless','logitech','g304']
  },
  {
    ...
    stock:10,is_featured:true,is_new:true,rating:4.6,review_count:14,
    tags:['gaming mouse','rgb','wired','cosmic byte']
  },
  {
    name:'EVOFOX Ronin TKL RGB Mechanical Gaming Keyboard',
    slug:'evofox-ronin-tkl-rgb-mechanical-gaming-keyboard',
    description:'EVOFOX Ronin TKL RGB mechanical wired gaming keyboard with a compact tenkeyless layout, mechanical switches, per-key RGB effects, anti-ghosting and USB connectivity.',
    short_description:'TKL mechanical RGB gaming keyboard with compact 79-key layout.',
    ...
    stock:10,is_featured:true,rating:4.5,review_count:952,
    tags:['gaming keyboard','mechanical','rgb','evofox']
  },
  {
    name:'Cosmic Byte GS430 Wired Gaming Headset',
    slug:'cosmic-byte-gs430-wired-gaming-headset',
    description:'Cosmic Byte GS430 wired over-ear gaming headset with 40mm drivers, deep bass, microphone and a 2.2m cable for PC, console and mobile gaming.',
    ...
    stock:10,is_featured:true,rating:4.2,review_count:13632,
    tags:['gaming headset','headset','microphone','cosmic byte']
  },
  {
    name:'Cosmic Byte Ares Pro Wireless Gamepad Tri-Mode',
    slug:'cosmic-byte-ares-pro-wireless-gamepad-tri-mode',
    description:'Cosmic Byte Ares Pro wireless gaming controller with wired and wireless connectivity, backlit controls, vibration support and compatibility with PC, Android and iOS.',
    ...
    stock:10,is_featured:true,rating:4.2,review_count:102,
    tags:['gaming controller','gamepad','wireless','cosmic byte']
  }
];

await mongoose.connect(process.env.MONGO_URI);
// Hide the old placeholder catalog. The curated list below becomes the only active catalog.
await Product.updateMany({},{$set:{is_active:false}});
