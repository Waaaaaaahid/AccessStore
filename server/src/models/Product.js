...
const productSchema = new mongoose.Schema({
  ...
  price:{type:Number,required:true,min:0}, original_price:{type:Number,min:0}, image_url:String, images:[String], source_url:String, source_store:String, category:String, tags:[String], variants:[String], sizes:[String], stock:{type:Number,default:0,min:0},
