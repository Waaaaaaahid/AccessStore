...
const productSchema = new mongoose.Schema({
  ...
  price:{type:Number,required:true,min:0}, original_price:{type:Number,min:0}, image_url:String, images:[String], category:String, variants:[String], sizes:[String], stock:{type:Number,default:0,min:0},
